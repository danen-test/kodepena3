...
$query = mysqli_query($conn, "select hak_akses from anggota where username_anggota ='$_SESSION[username]'");
$data = mysqli_fetch_assoc($query);

if ($data['hak_akses'] != 2) {
    header("location: login-anggota.php");
}
//End memeriksa hak akses

$query_data_user = mysqli_query($conn, "select * from anggota where username_anggota = '$usr'");
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <!-- <a href="index.html" class="logo mr-auto"><img src="assets/img/logo.png" alt=""></a>-->
        ...
        <ul>
          <li class="drop-down"><a >Iuran</a>
            <ul>
              <li><a href="anggota-home.php">Tagihan Iuran</a></li>
              <li><a href="anggota-riwayat-iuran.php">Riwayat Pembayaran Iuran</a></li>
            </ul>
          </li>
          <li><a href="anggota-merchandise.php">Merchandise</a></li>
          <li class="drop-down"><a >Pembelian Merchandise</a>
            <ul>
              <li><a href="anggota-pembelian-merch.php">Sedang Berlangsung</a></li>
              <li><a href="anggota-pembelian-dibatalkan.php">Dibatalkan</a></li>
              <li><a href="anggota-pembelian-selesai.php">Selesai</a></li>
            </ul>
          </li>
          <li class="drop-down"><a><?php echo $data_user['username_anggota']; ?></a>
            <ul>
              <li><a href="anggota-pembelian-merch.php">Pengaturan Profil</a></li>
              <li><a href="conf_logout.php">Log out</a></li>
            </ul>
          </li>
