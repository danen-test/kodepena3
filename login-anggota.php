                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Log In Anggota</h1>
                                    </div>
                                    <form class="user" action="conf-login.php" method="post">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="register.php">Mendaftar sebagai anggota</a>
                                    </div>
                                    <div class="text-center">
